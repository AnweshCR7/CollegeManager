...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        //For the little delay effect in popping the buttons
        mAnimationDelayPerItem = attr.getInt(R.styleable.FloatingActionsMenu_menu_animationDelayPerItem, 50);
        //For tinting the background once the button is clicked
        mBackgroundColor = attr.getColor(R.styleable.FloatingActionsMenu_menu_backgroundColor, Color.TRANSPARENT);
        attr.recycle();
                ...
                if (child instanceof FloatingActionButton
                    ...
                    mUiHandler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            fab.hide(animate);
                           /* TextView label = (TextView) fab.getTag(R.id.fab_label);
                            if (label != null) {
                                label.hide(animate);
                            }*/
