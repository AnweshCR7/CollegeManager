...
public class Subject_tt extends ActionBarActivity {
    ...
    class get_tt extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Subject_tt.this);
        ...
        protected String doInBackground(String... args) {
           ...
           // nameValuePair.add(new BasicNameValuePair("password", password));
            ...
            // getting JSON string from URL
            String jsonStr = sh.makeServiceCall(sub_url, ServiceHandler.GET);
            ...
            if (jsonStr != null) {
                try {
                    ...
                    // Getting JSON Array node
                    lecs = jsonObj.getJSONArray("lecs");
