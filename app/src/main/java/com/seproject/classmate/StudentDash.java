 ...
 *
  */
public class StudentDash extends AppCompatActivity implements OnProgressBarListener {
    /**
   ...
   // String user = intent.getExtras().getString("user_name", "INVALID");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.stu_dash);
       ...
       /* for(int j=0;j<=number;j++) {
            ...
            Log.d("HOPE: ", "> " + "--"+ subjects[j] +"--"+ percentage[j]);

            subject.setText(subjects[j]);
            subject.setTextColor(Color.BLACK);
            subject.setGravity(Gravity.CENTER);
            subject.setPadding(0, 20, 0, 20);
            ll.addView(subject);

            bnp = new NumberProgressBar(this);
            bnp.setProgressTextSize(70);
            bnp.setProgressTextColor(Color.RED);
            bnp.setUnreachedBarColor(Color.GREEN);
            bnp.setReachedBarColor(Color.RED);

            bnp.setReachedBarHeight(21);
            bnp.setUnreachedBarHeight(10);
            bnp.incrementProgressBy(percentage[j]);


            bnp.setPadding(25, 25, 25, 25);
            ll.addView(bnp);
            lm.addView(ll);
        }*/
        ...
        actionA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getBaseContext(), HelloGridView.class);
        ...
        actionD.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Toast.makeText(MainActivity.this, "Action B was clicked",
                //  Toast.LENGTH_SHORT).show();
                Intent l = new Intent(getBaseContext(), GetNotification.class);
                //j.putExtra("Main_Activity_call",1);
                startActivity(l);
            }
        });
    ...
    class get_less_attendance extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            String jsonStr = sh.makeServiceCall(get_attendance_url, ServiceHandler.GET);
            ...
            if (jsonStr != null) {
                try {
                    ...
                    subs = jsonObj.getJSONArray("list");
                    ...
                    for (int i = 0; i < subs.length(); i++) {
                        ...
                        subjects[i] = sub_name;
                        percentage[i] = c.getInt("attend_percent");
                       // Log.d("CHECK: ", "> " + "--"+ subjects[i] +"--"+ percentage[i]);
                    }
        ...
        protected void onPostExecute(String file_url) {
            for(int j=0;j<number;j++) {
                LinearLayout ll = new LinearLayout(StudentDash.this);
                ll.setOrientation(LinearLayout.VERTICAL);
                // Create TextView
                TextView subject = new TextView(StudentDash.this);
               // Log.d("HOPE: ", "> " + "--" + subjects[j] + "--" + percentage[j]);
                ...
                bnp = new NumberProgressBar(StudentDash.this);
                bnp.setProgressTextSize(70);
                bnp.setProgressTextColor(Color.RED);
                bnp.setUnreachedBarColor(Color.GREEN);
                bnp.setReachedBarColor(Color.RED);
    ...
    class get_subject_list extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String file_url) {
            ...
            final AlertDialog.Builder builder = new AlertDialog.Builder(StudentDash.this);
            builder.setTitle("What have you attended today?");
            ...
            btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    // Toast.makeText(StudentDash.this, "Wohoo! See You There!", Toast.LENGTH_SHORT).show();
                }
            });
    ...
    class update_attendance extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            for (int i = 0; i < selected_list.size(); i++) {
                ...
                url = "http://"+ip+"/classmate/v1/updateStudentAttendance/"+Email+"/"+subjects_text[selected_list.get(i)];
